//HANDLES: posts, likes / dislikes of comments, replys
function postComment(button, postedBy, videoId, replyTo, containerClass) {
    ...
    if(commentText) {
        ...
        $.post("includes/handlers/postComment.php", { commentText: commentText, postedBy: postedBy, 
            videoId: videoId, responseTo: replyTo })
        .done(function(comment){
            // alert(data);

            if(!replyTo) {
                $("." + containerClass).prepend(comment); //adds container class and comment
            }
            else {
...
function likeComment(commentId, button, videoId) {
    $.post("includes/handlers/likeComment.php", { commentId: commentId, videoId: videoId })
...
function dislikeComment(commentId, button, videoId) {
    $.post("includes/handlers/dislikeComment.php", { commentId: commentId, videoId: videoId })
    .done(function(numToChange) {
...
function getReplies(commentId, button, videoId) {
    $.post("includes/handlers/getCommentReplies.php", { commentId: commentId, videoId: videoId })
