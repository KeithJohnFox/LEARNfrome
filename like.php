...
<body>
    ...
    *{
    ...
    $usder_details_query = mysqli_query($con, "SELECT * FROM users WHERE username ='$user_liked'");
    $row = mysqli_fetch_array($user_details_query);
    $total_user_likes = $row['num_likes'];

    //Like button
	if(isset($_POST['like_button'])) {
        //Increment like when pressed
        $total_likes++;
    ...
    //Here we are checking for any previous likes
