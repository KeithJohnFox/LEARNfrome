...
<div class="messageContainer">
    <div class="request_column column" id="main_column">
        ...
        if(mysqli_num_rows($query) == 0)
            ...
            while($row = mysqli_fetch_array($query)) {
                ...
                $user_from_profile_pic = $user_from_obj->getProfilePic();
                ...
                ?>
                <form class="requestButtons" action="requests.php" method="POST">
                    <a href="<?php echo $user_from; ?>">
                     <img src="<?php echo $user_from_profile_pic; ?>" alt="User Picture">
                    </a>
                    <input type="submit" name="accept_request<?php echo $user_from; ?>" class="acceptButton" value="Accept">
                    <input type="submit" name="ignore_request<?php echo $user_from; ?>" class="ignoreButton" value="Ignore">
