...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/learnfrome/assets/images/profile_pictures';
	//Set File name	
...
<div class="settingsWrap">
	...
	<div class="profileUploadBox">
		...
		<div id="formExample">
			...
			<form id="uploadPicBox" action="upload.php" method="post"  enctype="multipart/form-data">
				<h4>Upload Profile Picture</h4>
				<input type="file" id="image" name="image" style="width:200px; height:30px; " />
				<input class="inputBoxpic" type="submit" value="Submit">
			</form><br /><br />
		...
		if($imgSrc){ //if an image has been uploaded display cropping area?>
			...
			<div class="photoWrap">
				<div id="CroppingContainer" style="max-width:1000px; width: auto; position: relative; background-color:#FFF; overflow:hidden;  z-index:2001; padding-bottom:0px;">  
				
					<div id="CroppingArea" style="width: auto; max-height:2000px; position: relative; overflow:hidden; margin:40px 0px 40px 40px; ">	
						<img src="<?=$imgSrc?>" border="0" id="jcrop_target" style="border:0px #990000 solid; margin:0px 0px 0px 0px; padding:0px; " />
					</div>  

					<div id="InfoArea" style="width:180px; height:150px; overflow:hidden; margin:0px 0px 0px 30px; border:0px #666 solid; float:left;">	
					<p style="margin:0px; padding:0px; color:#444; font-family: Nunito_Regular; font-size:18px;">          
